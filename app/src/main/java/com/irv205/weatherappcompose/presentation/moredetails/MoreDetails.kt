...
fun BodyDetails(domainWeather: DomainWeather, city: String, navigateBack: () -> Unit) {
    ...
    Scaffold(modifier = Modifier.fillMaxSize(), topBar = { HeaderView(title = city) {
        ...
        Column(modifier = Modifier
            ...
            Text(text = stringResource(id = R.string.more_details_temp, converKelvinToFahrenheit(domainWeather.temp)), style = MaterialTheme.typography.h1)
            Text(modifier = Modifier
                .fillMaxWidth()
                .padding(16.dp, 0.dp),
                text = stringResource(id = R.string.more_details_feels_like, converKelvinToFahrenheit(domainWeather.feels_like)), style = MaterialTheme.typography.body1, textAlign = TextAlign.End)
